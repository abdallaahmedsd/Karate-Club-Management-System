namespace Karate_Club.Instructors
{
	partial class frmAddInstructor
	{
		...
		private void InitializeComponent()
		{
			...
			this.tpExperience.Controls.Add(this.btnBackToSubscriptionInfo);
			...
			this.tpSpecializations.Controls.Add(this.btnGoToCurrentBelt);
			this.tpSpecializations.Controls.Add(this.btnBackToEmergencyContactInfo);
			...
			this.tpQualifications.Controls.Add(this.btnGoToSubscriptionInfo);
